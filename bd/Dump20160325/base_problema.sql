...
CREATE TABLE `problema` (
  ...
  KEY `id_ic` (`id_ic`),
  CONSTRAINT `problema_ibfk_1` FOREIGN KEY (`id_ic`) REFERENCES `ic` (`id_ic`)
...
INSERT INTO `problema` VALUES (1,'Teste','Testando',1,'Novo teste',22);
...
-- Dump completed on 2016-03-25 19:52:45
